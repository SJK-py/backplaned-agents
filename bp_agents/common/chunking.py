"""bp_agents.common.chunking — Markdown chunking ([data-model.md] §2.1).
...
Lives in `common` (not the knowledge_base agent) because it is a pure,
stdlib-only utility reused by both the knowledge base and the research
agent's content ranking — and the latter runs in a pyarrow-free runtime
that must not import the LanceDB-backed knowledge_base package.
"""
