    ...
    async def await_root_result(
        ...
        *,
        ...
        async with stream:
            ...
            # CONCURRENTLY with awaiting the result. `stream.result()` (with
            # its own timeout) is the authoritative terminator — the progress
            ...
            # wakes that queue. Driving the drain alone would therefore hang
            # past the timeout forever; awaiting the result alongside it bounds
            # the wait. See docs/backplaned/sdk/core.md §7.
