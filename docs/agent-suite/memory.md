...
- **Phase 1 — extract.** Decide whether the turn carries facts worth keeping (discard piecemeal / non-user-relevant info) and extract a deduped list of facts. (Dedup the batch here.)
